...
public class ColumnGroup {
    ...
    public ColumnGroup(String text, int type) {
        this(text, type, null);
    }

    public ColumnGroup(String text, int type, TableCellRenderer renderer) {
        this.text = text;
    ...
    public Dimension getSize(JTable table) {
        ...
        int height = comp.getPreferredSize().height + 10;//change height here
        int width = 0;
        for (ColumnGroup columnGroup : groups) {
